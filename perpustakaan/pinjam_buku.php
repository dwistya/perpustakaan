...
<div class = "row">
    <div class = "col-md-4">
    <img src="assets/foto_produk/2.jpg" class="card-img-top">
    </div>
    <div class = "col-md-8">
        <form action="masukkankeranjang.php?id_buku=<?php echo $dt_buku['id_buku']?>" method="post">
        <table class = "table table-hover table-striped">
            <thead>
                <tr>
                    <td> Nama Buku </td>
                    <td> <?php echo $dt_buku['judul_buku']?> </td>
                </tr>
                <tr>
                    <td> Penulis</td>
                    <td> <?php echo $dt_buku['penulis']?></td>
                </tr>
                <tr>
                    <td> Penerbit </td>
                    <td> <?php echo $dt_buku['penerbit']?></td>
                </tr>
                <tr>
                    <td> Jumlah Pinjam </td>
